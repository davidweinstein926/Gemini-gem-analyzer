# gemini_laser_analyzer.py - OPTIMIZED - FIXED NORMALIZATION FOR 0-100 COMPATIBILITY
...
class GeminiLaserAnalyzer:
    ...
    def file_selection_dialog(self):
        ...
        try:
            ...
            file_path = filedialog.askopenfilename(
                ...
                title="Select Gem Spectrum for FIXED Laser Analysis",
    ...
    def run_analysis(self):
        ...
        print("="*70)
        print("GEMINI LASER ANALYZER - FIXED NORMALIZATION")
        print("="*70)
